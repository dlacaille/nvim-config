...
vim.keymap.set('n', '<leader>fc', require('telescope.builtin').grep_string, { desc = 'Find cursor word' })
vim.keymap.set('n', '<leader>fw', require('telescope.builtin').live_grep, { desc = 'Find by words' })
...
-- Workaround for https://github.com/nvim-telescope/telescope.nvim/issues/2766
